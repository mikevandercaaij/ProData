...
public class addStudent implements Node {
    ...
    public VBox getNode() {
        ...
        // title
        Label headerText = new Label("Add a Student");
        ...
        submitButton.setOnAction((event) -> {
            ...
            if (status) {
                ...
                studentController.Student newStudent = new studentController.Student(email.getText(),
